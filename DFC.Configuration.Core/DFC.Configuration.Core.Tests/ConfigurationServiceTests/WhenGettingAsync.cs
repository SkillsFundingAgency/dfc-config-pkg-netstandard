...
namespace DFC.Configuration.Core.Tests.ConfigurationServiceTests
{
    public class WhenGettingAsync
    {
        ...
        public void Arrange()
        {
            ...
            _configurationRepo.Setup(repo => repo.GetAsync("DFC.Configuration.Core.Tests", "Dev", "1.0")).Returns(Task.FromResult(devConfig));
            _configurationRepo.Setup(repo => repo.GetAsync("DFC.Configuration.Core.Tests", "SIT", "1.0")).Returns(Task.FromResult(sitConfig));

            _options = new ConfigurationOptions("DFC.Configuration.Core.Tests", "Dev", "1.0");
