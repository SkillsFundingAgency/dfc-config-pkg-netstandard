...
namespace DFC.Configuration.Core.Tests.ConfigurationServiceTests
{
    public class WhenGetting
    {
        ...
        public void Arrange()
        {
            ...
            _configurationRepo.Setup(repo => repo.Get("DFC.Configuration.Core.Tests", "Dev", "1.0")).Returns(_devConfig);
            _configurationRepo.Setup(repo => repo.Get("DFC.Configuration.Core.Tests", "SIT", "1.0")).Returns(sitConfig);
